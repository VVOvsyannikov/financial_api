...
RSpec.describe "API::V1::Users", type: :request do
  ...
  context "with existing user" do
    ...
    let(:valid_data) { { "user" => { "id" => user.id, "balance" => user.balance.to_s } } }
    ...
    it "deposits money" do
      post "/api/v1/users/#{user.id}/deposit", params: { amount: 100 }, headers: auth_headers
    ...
    it "withdraws money" do
      ...
      post "/api/v1/users/#{user.id}/withdraw", params: { amount: 30 }, headers: auth_headers
    ...
    it "cannot withdraw more than balance" do
      post "/api/v1/users/#{user.id}/withdraw", params: { amount: 100 }, headers: auth_headers
